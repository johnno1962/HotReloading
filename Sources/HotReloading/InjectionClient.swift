...
//
//  $Id: //depot/HotReloading/Sources/HotReloading/InjectionClient.swift#51 $
//
    ...
    func process(command: InjectionCommand, builder: SwiftEval) {
        ...
        case .objcClassRefs:
            if let objcClassRefs = readString()?
                ...
                SwiftInjection.objcClassRefs =
                    objcClassRefs.mutableCopy() as! NSMutableArray
            }
        case .descriptorRefs:
            if let descriptorRefs = readString()?
                .components(separatedBy: ",") as? NSArray {
                SwiftInjection.descriptorRefs =
                    descriptorRefs.mutableCopy() as! NSMutableArray
            }
        case .setXcodeDev:
